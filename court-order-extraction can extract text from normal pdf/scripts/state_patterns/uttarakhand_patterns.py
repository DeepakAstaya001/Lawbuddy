# Regex patterns for UTTARAKHAND courts

PATTERNS = {
    "court_name": [
        r"IN THE (HIGH COURT OF UTTARAKHAND AT [^\n]+)",
        r"(HIGH COURT OF UTTARAKHAND AT [^\n]+)",
    ...
    "case_number": [
        r"Writ Petition No\.\s*(\d+\s*of\s*\d{4})\s*\(S/B\)",
    ...
    "alternate_case_number": [
        r"Reference – Writ Petition No\.\s*(\d+\s*of\s*\d{4}\s*\(S/B\))",
        r"before the Division[^\n]*Writ Petition No\.\s*(\d+\s*\(S/B\)\s*of\s*\d{4})",
        r"Writ Petition No\.\s*(\d+\s*\(S/B\)\s*of\s*\d{4})"
    ],
    ...
    "judge_name": [
        r"Hon'ble Justice ([A-Z][a-zA-Z\s]+)",
        r"\(([A-Z][a-zA-Z\s]+, J\.)\)",
        r"Hon\.\s*([A-Z][a-zA-Z\s]+, J\.)",
        r"Hon'ble\s*([A-Z][a-zA-Z\s]+, J\.)",
        r"PRESENT[^\n]*\n[^\n]*JUSTICE\s+([^\n]+)",
